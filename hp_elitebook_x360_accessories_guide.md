...
```mermaid
graph TD
    Step1["1. Order Laptop: HP EliteBook x360 830 G8 (2,199 ₪ / Ecology Computers)"] --> Step2{"Did Ecology include a Pen?"}
    
    Step2 -- "Yes (or small +50 ₪ add-on)" --> PenDone["✅ Pen Solved!"]
    Step2 -- "No" --> BuyPen["🛒 Order HP Rechargeable Active Pen G3 (~120 ₪ on AliExpress / Japan)"]
    
    PenDone --> FilmChoice{"Do you write a lot or mostly type?"}
    BuyPen --> FilmChoice
