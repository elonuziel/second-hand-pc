...
```mermaid
graph TD
    Start["What is your primary use case for a 2-in-1?"] --> Q1{"Do you need a 360° flip hinge (Tablet Mode) or just a Touchscreen?"}
    
    Q1 -- "360° Convertible (Tablet/Tent/Stand)" --> Q2{"Do you want a built-in stylus pen inside the laptop?"}
    Q1 -- "Standard Clamshell Touchscreen" --> Q3{"Do you want a 3:2 High-Res display or Business Durability?"}
    
    Q2 -- "Yes, Garage Pen Docking" --> A1["👑 Lenovo ThinkPad X1 Yoga Gen 6 (1,900 ₪)"]
    Q2 -- "No, Maximum Warranty / 2 Years" --> A2["🛡️ HP EliteBook x360 830 G8 (2,199 ₪)"]
    Q2 -- "No, Maximum 32GB RAM Power" --> A3["🚀 HP ProBook x360 435 G7 (1,900 ₪)"]
    
    Q3 -- "3:2 High-Res PixelSense" --> A4["🎨 Microsoft Surface 4 32GB/1TB (1,900 ₪)"]
    Q3 -- "Business Durability + 24M Warranty" --> A5["🏢 Lenovo ThinkPad T14 Touch (1,849 ₪)"]
```
